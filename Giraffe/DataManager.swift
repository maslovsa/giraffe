...
//        goals = [GoalItem]()
    ...
    func getTasks(completion: ([TaskItem]) -> Void) {
        ...
        let task2 = TaskItem(id: "1", title: "Реши меня", type : .Math, exercise: "2+2", result: "4")
        let task3 = TaskItem(id: "2", title: "Реши меня", type : .Math, exercise: "2+2", result: "4")
        let task4 = TaskItem(id: "3", title: "Реши меня", type : .Math, exercise: "2+2", result: "4")
